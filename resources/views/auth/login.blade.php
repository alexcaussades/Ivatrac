    ...
    <div class="row">
        <div class="col-sm">
            <form action="{{ route("auth.login") }}" method="post">
                ...
                <div class="form-group">
                    <label for="password"><span class="d-flex align-items-center"><span class="material-symbols-outlined">fingerprint</span> Password <span class="text-danger fw-bold ms-2">*</span></span></label>
