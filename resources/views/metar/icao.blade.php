...
<div class="container" style="margin-top: 20px;">
    <div class="row">
        <div class="col-md-12">
            <h1><span class="material-symbols-outlined">connecting_airports</span> {{$metar["station"]}}</h1>
        </div>
        <div class="d-flex">
    ...
    <div class="d-flex flex-row-reverse text-warning"><span class="material-symbols-outlined fill">star</span></div>
    <div class="mt-2">
    </div>
    <div class="card mt-2">
        <div class="card-body">
            <h4 class="card-title d-flex align-items-center"><span class="material-symbols-outlined">info</span> {{$metar["metar"]}}</h4>
            <p class="card-text">
